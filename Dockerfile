...
RUN apt update -y
RUN apt upgrade -y
RUN apt install -y emacs vim tmux apt python3-venv pandoc gdebi fonts-wqy-microhei python3-pip python3-virtualenv git nodejs npm curl default-jre cmake
